...
pcall(function()
	userinfo = HttpService:JSONDecode(readfile("libinfo.lua"));
end)
...
local function SaveInfo()
	...
	userinfo["user"] = user
	userinfo["tag"] = tag
	writefile("libinfo.lua", HttpService:JSONEncode(userinfo));
end
...
function DiscordLib:Window(text)
	...
	UserPanel.BackgroundColor3 = Color3.fromRGB(27, 27, 27)
	...
	UserPanelUserIcon.MouseButton1Click:Connect(function()
		...
		TextBoxFrame1.BackgroundColor3 = Color3.fromRGB(44, 44, 44)
		...
		ChangeBtn.BackgroundColor3 = Color3.fromRGB(78, 0, 121)
		...
		CloseBtn1.BackgroundColor3 = Color3.fromRGB(78, 0, 121)
		...
		ResetBtn.BackgroundColor3 = Color3.fromRGB(78, 0, 121)
				...
				Toggle.MouseButton1Click:Connect(function()
					if toggled == false then
						TweenService:Create(
							Icon,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{ImageColor3 = Color3.fromRGB(78, 0, 121)}
						):Play()
						TweenService:Create(
							ToggleFrame,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
